...
const Message = (props)=> {
    return(
        <div class="container-fluid" >
                    ...
                    {props.speaks==='bot' && 
                    <div className="card bg-info"  style={{position:"left", display:"flex", margin: 0, paddingBottom: '5%', paddingTop: '5%', height: '90%', textAlign: 'auto',  display:"flex",justifyContent: "center", alignItems: "center"}}>
